...
const QHash<QString, QStringList>& table() {
    static const QHash<QString, QStringList> t = {
        ...
        // places
        {"temp",    {"M5 22h14M5 2h14", "M17 22v-4.172a2 2 0 0 0-.586-1.414L12 12l-4.414 4.414A2 2 0 0 0 7 17.828V22M7 2v4.172a2 2 0 0 0 .586 1.414L12 12l4.414-4.414A2 2 0 0 0 17 6.172V2"}},
        {"peer",    {"M4.5 15.5h15a1 1 0 0 1 1 1v2a1.5 1.5 0 0 1-1.5 1.5H5A1.5 1.5 0 0 1 3.5 18.5v-2a1 1 0 0 1 1-1z", "M12 15.5V11M5.5 11h13M8.5 11V8.5a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1V11M7 18h.01"}},
        ...
        {"pack",    {"m7.5 4.27 9 5.15M21 8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16ZM3.3 7 12 12l8.7-5M12 22V12"}},
    };
    return t;
}
}
